...
public class Solution extends SimpleFileVisitor<Path> {
    ...
    public FileVisitResult visitFile(Path file, BasicFileAttributes attrs) throws IOException {
        ...
        String fileNameExtention = fileName.substring(fileNameLenght - 4);
        if (".zip".equals(fileNameExtention) || ".rar".equals(fileNameExtention)) {
            archived.add(fileName);
        }
        System.out.println("archived.size(): " + archived.size());
